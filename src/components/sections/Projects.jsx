            ...
            <h2 className="text-3xl font-bold mb-8 bg-gradient-to-r from-blue-500 to-cyan-400 bg-clip-text text-transparent text-center">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div className="p-6 rounded-xl border border-white/10 hover:-translate-y-1 hover:border-blue-500/30 hover:shadow-[0_2px_8px_rgba(59,130,246,0.1)] transition-all">
                        ...
                        <p className="text-gray-400 mb-4">A game that was built with my team as part of our Data Structures & Algorithms course. This isfocused on efficient board management using a 2D array and optimized AI decision-making. Implemented the Minimax algorithm with Alpha-Beta Pruning to enhance AI performance, reducing unnecessary computations and ensuring strategic move selection. The game has a real-time move validation system, dynamic win detection, and an interactive game loop for smooth gameplay. This project strengthened my skills in algorithm optimization, data structures, and problem-solving in Java. 🎯</p>
                            <div className="flex flex-wrap gap-2">
                    ...
                    <div className="p-6 rounded-xl border border-white/10 hover:-translate-y-1 hover:border-blue-500/30 hover:shadow-[0_2px_8px_rgba(59,130,246,0.1)] transition-all">
                        <h3 className="text-xl font-bold mb-2">Retail Employee Discount System</h3>
